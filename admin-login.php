...
.form {
  ...
  z-index: 1;
  background: #122457;
  background-image: url(images/log21.jpg);
...
background-image: url(images/log20.jpg) ;
  ...
  background-size: cover;  /*background: -webkit-linear-gradient(right, #76b852, #8DC26F);
				...
				<!---Brand and toggle get grouped for better mobile display-->
						<div class="navbar-header">
							<div class="navbar-brand">
								<h1><a href=""><center>Shoppingdil Admin Login Page</center></a></h1>
							</div>
						</div>
					</div>
				</nav>
